    ...
    return(
        <div className="px-5 py-10 sm:px-20 transition-all duration-150 ease-in-out" id="project">
            <div className="flex justify-center flex-col gap-5">
                ...
                >
                    <div className="group relative overflow-hidden" onClick={()=>openInNewtab('https://github.com/markaeroltomarse/onems')}>
                        {/* overlay */}
                        <div className="group-hover:bg-gray-500/70 w-full h-full absolute z-40 transition-all duration-300"></div>
                        {/* img */}
                        <img className="group-hover:scale-125 transition-all duration-500" src={Images.capstone} alt=""/>
                        {/* title */}
                        ...
                        <div className="absolute  -bottom-full left-8 group-hover:bottom-8 transition-all duration-500 z-50">
                            <span className="text-white text-2xl">Online Enrollment System </span>
                        </div>
                    </div>

                    <div className="group relative overflow-hidden" onClick={()=>openInNewtab('https://github.com/Alexhabig/Todo-List')}>
                        {/* overlay */}
                        <div className="group-hover:bg-gray-500/70 w-full h-full absolute z-40 transition-all duration-300"></div>
                        {/* img */}
                        <img className="group-hover:scale-125 transition-all duration-500" src={Images.todo} alt=""/>
                        {/* title */}
                        <div className="absolute  -bottom-full left-8 group-hover:bottom-16 transition-all duration-500 z-50">
